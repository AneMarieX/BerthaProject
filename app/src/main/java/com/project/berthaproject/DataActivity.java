...
public class DataActivity extends AppCompatActivity {
    ...
    private Data data;
    private EditText  pm25View , pm10View, co2View, o3View, pressureView, temperatureView, humidityView ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headingView.setText("Data Id=" + data.getDeviceId());
    ...
    public void deleteData(View view) {
        ...
        task.execute("https://berthabackendrestprovider.azurewebsites.net/api/data/anbo/1550823829244" + data.getDeviceId());
        finish();
    }
